        ...
        {isSubmitted ? (
          <div className="text-center py-12 space-y-6 animate-fade-in">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-bold tracking-superwide uppercase">ORDER CONFIRMED</h2>
              <p className="text-sm text-slate-400 font-mono">
                Order reference: <span className="text-electric-400">#MVRQ-2026-{(Math.random()*90000+10000).toFixed(0)}</span>
              </p>
              <p className="text-xs text-slate-300 light:text-slate-600 max-w-md mx-auto pt-2">
                Thank you for choosing MVRQ by naMLez. We have received your order details and our courier team in Lagos will reach out shortly via phone/WhatsApp.
              </p>
            </div>
            <button
              onClick={handleClose}
          ...
          <div className="space-y-6">
            <div className="border-b border-navy-800 light:border-slate-200 pb-4">
              ...
              <p className="text-xs text-slate-400 font-mono">
                Direct Courier Delivery & Payment Verification
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-navy-950/60 light:bg-slate-50 p-4 rounded-xl border border-navy-800 light:border-slate-200 space-y-4">
                ...
                <div className="border-t border-navy-800 light:border-slate-200 pt-3 flex justify-between items-center font-mono text-sm">
                  ...
                  <span className="font-bold text-electric-400 text-base">{formatPrice(subtotal)}</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center space-x-2 text-[11px] text-slate-400 font-mono bg-navy-950/40 p-2.5 rounded-lg border border-navy-850">
                  ...
                  <span>Encrypted checkout. Order dispatch verified via SMS / Call.</span>
                </div>

                <button
                  type="submit"
                  className="w-full bg-electric-600 hover:bg-electric-500 text-white font-bold text-xs tracking-superwide uppercase py-3.5 rounded-xl transition-all shadow-lg shadow-electric-500/25"
                >
                  PLACE PRE-ORDER
                </button>
              </form>
